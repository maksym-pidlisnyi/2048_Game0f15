...
class GameOfFifteen(private val initializer: GameOfFifteenInitializer) : Game {
    ...
    override fun processMove(direction: Direction) {
        ...
        board.apply {
            nonZero = zero.getNeighbour(direction.opposite())
        }
        if (nonZero == null)
            return
    ...
    override fun get(i: Int, j: Int) = board.run { get(getCell(i, j)) }

    private fun findNull() = board.getAllCells().find { get(it.i, it.j) == null }!!
